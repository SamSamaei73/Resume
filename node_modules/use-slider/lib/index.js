...
function initPagination(container, pagination, curIndex, moveTo) {
    var oldPaginationNode = container.querySelector(".slider-pagination-container");
    ...
    for (var i = 0; i < container.querySelectorAll(".slider-slide").length; i += 1) {
        _loop_1(i);
    }
...
function usePagination(options) {
    ...
    react.useEffect(function () {
        if (!container || !pagination)
            return;
        var paginationContainer = container.querySelector(".slider-pagination-container");
...
function initNavigation(container, navigation, prev, next, arrowLeft, arrowRight) {
    if (navigation || arrowLeft || arrowRight) {
        var oldNavigationNode = container.querySelector(".slider-navigation-container");
        ...
        if (arrowLeft)
            navigationList.push(react.cloneElement(arrowLeft, {
                onClick: prev,
                className: (arrowLeft.props.className ? arrowLeft.props.className : "") + " slider-navigation-left"
            }));
        if (arrowRight)
            navigationList.push(react.cloneElement(arrowRight, {
                onClick: next,
                className: (arrowRight.props.className ? arrowRight.props.className : "") + " slider-navigation-right"
            }));
...
function init(container, slidesPerView) {
    ...
    for (var i = 0; i < container.children.length; i += 1) {
        var child = container.children[i];
        if (child.classList.contains("slider-pagination-container") ||
